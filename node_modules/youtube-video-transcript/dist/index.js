...
var __require, net, url, httpProxy, http, https, getProxyForUrl, corsServer, src_default;
var init_dist = __esm({
  "../youtube-video-core/node_modules/tiny-cors-proxy/dist/index.mjs"() {
    ...
    if (typeof module !== "undefined" && module.exports) {
      net = __require("net");
      url = __require("url");
      httpProxy = __require("http-proxy");
      http = __require("http");
      https = __require("https");
      getProxyForUrl = __require("proxy-from-env").getProxyForUrl;
    }
...
__export(src_exports, {
  ...
  InvalidVideoUrlError: () => InvalidVideoUrlError,
  LanguageNotAvailableError: () => LanguageNotAvailableError,
  TooManyRequestsError: () => TooManyRequestsError,
  TranscriptionDisabledError: () => TranscriptionDisabledError,
